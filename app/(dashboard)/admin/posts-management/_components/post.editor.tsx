...
import {
  ...
  EditorSidebar,
  TitleName,
} from "@/app/(dashboard)/_lib/tiptap.types";
...
import { useCourseSidebar } from "../../course-management/_lib/useCourseSidebar";
import { newPost } from "../_lib/posts.actions";
import blogSchema, { BlogSchema } from "../_lib/posts.schema";
import BlogMeta from "./post.meta";
