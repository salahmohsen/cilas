  ...
  return (
    <>
      <Tabs defaultValue="profile" className="flex min-w-96" orientation="vertical">
        <TabsList className="my-0 flex h-full w-1/3 flex-col items-start justify-start overflow-hidden rounded-r-none border-r p-0 px-0 *:flex *:w-full *:gap-3 *:rounded-none *:py-5">
        ...
        <TabsContent value="profile">
          <div className="flex items-center gap-4">
            ...
            <div className="border-border flex flex-col items-center border">
              <p>
