CREATE TABLE "course_bundle" (
	...
	CONSTRAINT "course_bundle_name_unique" UNIQUE("name")
);
...
CREATE TABLE "author_to_role" (
	...
	CONSTRAINT "author_to_role_author_id_post_id_pk" PRIMARY KEY("author_id","post_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "blog_posts_rules" (
	"id" serial PRIMARY KEY NOT NULL,
	"ar_name" varchar(255),
	"en_name" varchar(255) NOT NULL,
	"description" varchar(255),
	CONSTRAINT "blog_posts_rules_ar_name_unique" UNIQUE("ar_name"),
	CONSTRAINT "blog_posts_rules_en_name_unique" UNIQUE("en_name")
);
--> statement-breakpoint
CREATE TABLE "series" (
	"id" serial PRIMARY KEY NOT NULL,
...
ALTER TABLE "course" ADD CONSTRAINT "course_bundle_id_course_bundle_id_fk" FOREIGN KEY ("bundle_id") REFERENCES "public"."course_bundle"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "author_to_role" ADD CONSTRAINT "author_to_role_post_id_blog_posts_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."blog_posts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "author_to_role" ADD CONSTRAINT "author_to_role_rule_id_blog_posts_rules_id_fk" FOREIGN KEY ("rule_id") REFERENCES "public"."blog_posts_rules"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "blogs_to_categories" ADD CONSTRAINT "blogs_to_categories_blog_id_blog_posts_id_fk" FOREIGN KEY ("blog_id") REFERENCES "public"."blog_posts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "blogs_to_tags" ADD CONSTRAINT "blogs_to_tags_blog_id_blog_posts_id_fk" FOREIGN KEY ("blog_id") REFERENCES "public"."blog_posts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "series_posts" ADD CONSTRAINT "series_posts_post_id_blog_posts_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."blog_posts"("id") ON DELETE cascade ON UPDATE no action;